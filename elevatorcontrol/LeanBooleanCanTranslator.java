 ...
 * @author justinr2
 */
public class LeanBooleanCanTranslator extends CanPayloadTranslator {

    String name;

    LeanBooleanCanTranslator(WriteableCanMailbox payload, int expectedMask, String name) {
        super(payload, 1, expectedMask);
        this.name = name;
    }
    
    LeanBooleanCanTranslator(ReadableCanMailbox payload, int expectedMask, String name) {
        super(payload, 1, expectedMask);
        this.name = name;
    }
